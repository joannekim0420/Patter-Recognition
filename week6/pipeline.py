...
def run(img):
    ...
    edge_img = cv2.Canny(blur_img, threshold1=70, threshold2=150, apertureSize = 3)
    ...
    lines = cv2.HoughLinesP(roi_img,1, np.pi / 180, 10, 10, 3)
                            #input image
    ...
    for line in lines:
        for x1, y1, x2, y2 in line:
            cv2.line(result, (x1, y1), (x2, y2), (0, 0,255 ), 3)   #BGR
